...
## [Update] Before building this project, see [mockc-slang README](https://github.com/yangdinglou/mockc-slang#using-your-xx-slang-in-your-local-source-academy) to link the language for the use.
...
See [mockc-slang README](https://github.com/yangdinglou/mockc-slang#using-your-xx-slang-in-your-local-source-academy) for instructions how to run your own xx-slang in the frontend.
