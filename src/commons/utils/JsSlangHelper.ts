...
import createSlangContext from 'mockc-slang/dist/createContext';
import { Context, Value, Variant } from 'mockc-slang/dist/types';
import { stringify } from 'mockc-slang/dist/utils/stringify';
 ...
 * It uses the mockc-slang stringify to convert values into a "nicer"
...
/**
 * A wrapper around mockc-slang's createContext. This
...
export function makeElevatedContext(context: Context) {
  ...
  // The mockc-slang will defineProperty on loadStandardLibraries
